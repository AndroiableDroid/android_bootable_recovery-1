...
static void get_data_file_encryption_modes(PolicyKeyRef* key_ref) {
    LOG(ERROR) << "get_data_file_encryption_modes\n";
    ...
    LOG(ERROR) << "get_data_file_encryption_modes::key_ref->contents_mode::" << key_ref->contents_mode << "\n";
    key_ref->filenames_mode = entry->file_names_mode;
    LOG(ERROR) << "get_data_file_encryption_modes::key_ref->filenames_mode::" << key_ref->filenames_mode << "\n";
}
